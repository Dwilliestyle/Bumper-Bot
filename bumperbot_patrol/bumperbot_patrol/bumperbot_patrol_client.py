...
class BumperbotPatrolClient(Node):

    def __init__(self):
        super().__init__('bumperbot_patrol_client')

        print('Bumperbot Patrol Client')
        print('----------------------------------------------')
        print('Input below')
        ...
        self._action_client = ActionClient(self, Patrol, 'bumperbot')
...
def main(args=None):
    ...
    bumperbot_patrol_client = BumperbotPatrolClient()
    rclpy.spin(bumperbot_patrol_client)
